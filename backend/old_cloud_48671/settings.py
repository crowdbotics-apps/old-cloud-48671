"""
Django settings for old_cloud_48671 project.
...
ROOT_URLCONF = 'old_cloud_48671.urls'
...
WSGI_APPLICATION = 'old_cloud_48671.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Old Cloud Support <support@old-cloud-48671.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "old_cloud_48671 API",
    "DESCRIPTION": "API documentation for old_cloud_48671 App",
    "VERSION": "v1",
}
